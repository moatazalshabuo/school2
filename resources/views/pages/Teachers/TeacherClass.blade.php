        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('teacher_class.create') }}" class="btn btn-success btn-sm" role="button"
                                aria-pressed="true">{{ trans('Teacher_trans.Add_Subject_Teacher') }}</a><br><br>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            {{-- <th>{{ trans('Teacher_trans.Class') }}</th>
                                            <th>{{ trans('Teacher_trans.Subject') }}</th> --}}
                                            <th>{{ trans('Teacher_trans.Academy_year') }}</th>
                                            {{-- <th>العمليات</th> --}}
                                        </tr>
                                    </thead>
                                    <tbody>
