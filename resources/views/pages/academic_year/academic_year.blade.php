                ...
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <tbody>
                        ...
                        @foreach ($academicYears as $academicYear)
                                                ...
                                                @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input id="start_date" type="date" name="start_date" class="form-control" min="2020" value="{{ $academicYear->start_date }}">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input id="end_date" type="date" name="end_date" class="form-control" min="" value="{{ $academicYear->end_date }}">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <select class="form-control" name="status">
                                                            <option value="1" {{ $academicYear->status == 1 ? 'selected' : '' }}>
                                                                {{ trans('Grades_trans.active') }}
                                                            </option>
                                                            <option value="0" {{ $academicYear->status == 0 ? 'selected' : '' }}>
                            ...
                            <!-- delete_modal_Grade -->
                            <div class="modal fade" id="delete{{ $academicYear->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('academic_year.destroy', 'test') }}" method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
                                                {{ trans('Grades_trans.Warning_AcademicYear') }}
                                                <input id="id" type="hidden" name="id" class="form-control" value="{{ $academicYear->id }}">
                                                <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('academic_year.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="start_date" class="mr-sm-2">{{ trans('Grades_trans.stage_name_ar') }}
                                :</label>
                            {{-- <input id="start_date" type="date" name="start_date" class="form-control"> --}}
                            <input id="start_date" type="date" name="start_date" class="form-control" min="2020" value="{{ date('Y-m-d') }}">

                        </div>
                        <div class="col">
                            <label for="end_date" class="mr-sm-2">{{ trans('Grades_trans.stage_name_en') }}
                                :</label>
                            {{-- <input type="date" class="form-control" name="end_date"> --}}
                            {{-- <input id="end_date" type="date" name="end_date" class="form-control" min="2020" value="{{ date('Y-m-d') + 1 }}"> --}}
                            <input id="end_date" type="date" name="end_date" class="form-control" min="{{ date('Y-m-d', strtotime('+1 year')) }}" value="{{ date('Y-m-d', strtotime('+1 year')) }}">

                        </div>
                    </div>
                    <div class="col">
                        <label for="status" class="mr-sm-2">{{ trans('Grades_trans.stage_name_en') }}:</label>
                        <select class="form-control" name="status">
